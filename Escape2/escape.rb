...
class Escape < Gosu::Window
	...
	def draw
		@camera.view do 
			(0..3).each do |row|
				(0..1).each do |col|
					@background.draw(799 * col, 529 * row, 0)
				end
			end
			@sign.draw(1450, 30, 2)
			@player.draw
	...
	def draw_credits
		color = 0xff00ff00
		@font.draw_text('Gome Won!', 240, 150, 3, 2, 2, color)
		@font_small.draw_text('Images from the SpriteLib Collection', 100, 300, 3, 2, 2, color)
		@font_small.draw_text('by WidgetWorx under the terms of the', 100, 350, 3, 2, 2, color)
		@font_small.draw_text('Common Public License.', 100, 400, 3, 2, 2, color)
		@font_small.draw_text('Music: Zanzibar, by Kevin MacLeod', 100, 500, 3, 2, 2, color)
		@font_small.draw_text('(incompetech.com)', 100, 550, 3, 2, 2, color)
		@font_small.draw_text('Licensed under', 100, 600, 3, 2, 2, color)
		@font_small.draw_text('Creative Commons: By Attribution 3.0', 100, 650, 3, 2, 2, color)
		@font_small.draw_text('http://creativecommons.org/licenses/by/3.0', 100, 700, 3, 2, 2, color)
	end
